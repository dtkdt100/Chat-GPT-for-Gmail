...
function getNewMessageTextDialog() {
  return document.querySelector('.Am.Al.editable');
}

function setChatGPTButton(con, textDialog) {

  var pos = textDialog.getBoundingClientRect();
  con.style.left = (pos.left+20)+"px";
  con.style.bottom = (window.innerHeight-pos.bottom+5)+"px";
}

function setContainerPosUnderText(con, textDialog) {
  var pos = getLastTextPosition(textDialog);
  con.style.top = (Math.ceil(pos.top+pos.height))+"px";
  con.style.left = (pos.left-10)+"px";
  con.style.width = "360px";
